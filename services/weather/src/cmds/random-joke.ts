...
const jokes = {
  ...
  "101":
    "The next time you're using Safari or Firefox and it's running slowly, you can say to yourself,<br/> \"I could've had a V8 (a browser 'engine')\".",
  "102": {
  ...
  "139":
    "Lisp programmers don't make prank calls. They make <code>FUNCALL</code>s",
  "140": {
  ...
  "152":
    "I'm starting a band called 1023MB. I don't think we'll ever get a gig.",
  "153": {
  ...
  "156":
    "Dev 1 -  We have a problem. Dev 2 -  Let’s use RegEx! Dev 1 -  Now we have two problems",
  "157": {
  ...
  "160":
    "UNIX is very user friendly... It's just very particular about who its friends are.",
  "161": "Debugging: Removing the needles from the haystack.",
  "162": "You are the CSS to my HTML",
  "163":
    "An optimist says: “the glass is half full.”<br/>A pessimist says: “the glass is half empty.”<br/>A programmer says: “the glass is twice as large as necessary.",
  "164":
    "CSS developers have the biggest ego, they think they're so !important",
  "165": {
    q: "Hamlet: To be - or not to be...",
    a: "Programmer: True !",
  },
  "166":
    'The Professor says "Welcome to English 101".The student panicks."What\'s wrong?" asks the Professor.<br/><br/>"I missed the first 4 English classes".',
  "167": {
  ...
  "175":
    "When an Apple employees dies, does their life HTML5 in front of their eyes?",
  "176": {
    q: "What's 0.1+0.2?",
  ...
  "180":
    "A data Scientist goes to a bar and sees two tables. Then he says: Hey bro... Can I join you?",
  ...
  "188":
    'If the box says: "This software requires Windows XP or better". Does that mean it will run on Linux?',
  "189": {
...
const jokesNumber = Object.keys(jokes).length;

export default () => {
  const key = String(randomNumber(0, jokesNumber)) as keyof typeof jokes;
